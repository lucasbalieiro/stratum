...
- **Visibility Preserved**: The generated `{Name}Owned` struct and each of its fields carry the visibility written on the source struct and fields (`pub`, `pub(crate)`, `pub(super)`, private).
